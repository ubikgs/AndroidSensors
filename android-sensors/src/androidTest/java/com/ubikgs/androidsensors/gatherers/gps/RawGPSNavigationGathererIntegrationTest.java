 ...
 */
public class RawGPSNavigationGathererIntegrationTest extends RawGPSGathererIntegrationTest {

    @Inject RawGPSNavigationGatherer rawGPSNavigationGatherer;
    ...
    public void setUp() throws Exception {
        ...
        sensorGatherer = rawGPSNavigationGatherer;
    ...
    protected Class<? extends SensorRecord> getSensorRecordClass() {
        return RawGPSNavigationRecord.class;
    }
}